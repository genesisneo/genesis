  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="I started as a web designer in the Philippines way back 2004 and now a front-end developer based in Dubai, United Arab Emirates."
        />
        ...
        <meta
          ...
          content="I started as a web designer in the Philippines way back 2004 and now a front-end developer based in Dubai, United Arab Emirates."
        />
        <meta property="og:url" content={`${siteDomain}/about`} />
          ...
          <div className={styles['Details-information']}>
            ...
            <p className={styles['Details-items']}>
              ...
              <span className={styles['Details-body']}>
                ...
                Git, NodeJS, EpressJS, ReactJS, VueJS, ElectronJS, Firebase, WebPack, Gulp,
                and Grunt.
              </span>
              <span className={styles['Details-body']}>
